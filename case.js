...
async function handleCase(sock, message) {
  ...
  switch (command) {
    case 'halo':
      ...
      break;
    case 'menu': {
      // Bangun menu dinamis dengan tampilan yang lebih keren menggunakan box-drawing characters
      // 1. Ekstrak perintah built-in dari source code (berdasarkan pola "case 'nama':")
